...
int main(int argn, char* args[]) {
  ...
  ros::ServiceClient map_client = nh.serviceClient<nav_msgs::GetMap>("/map_server/static_map");
  ...
  nav_msgs::OccupancyGridPtr occ_map = nav_msgs::OccupancyGridPtr(new nav_msgs::OccupancyGrid);
