...
extern "C" bool plan(const char *mapFilename, double mapResolution,
                     double robotRadius, double startX, double startY,
  ...
  si->setStateValidityChecker(
      ob::StateValidityCheckerPtr(new SimpleStateValidityChecker(
          si, mapFilename, (float)mapResolution, (float)robotRadius)));
